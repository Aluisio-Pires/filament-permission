 ...
 *
 * @mixin \AluisioPires\Permission\Models\Role
 *
 * @phpstan-require-extends \AluisioPires\Permission\Models\Role
 */
interface Role
{
    /**
     ...
     *
     *
     * @throws \AluisioPires\Permission\Exceptions\RoleDoesNotExist
     */
     ...
     *
     * @param  string|int|\AluisioPires\Permission\Contracts\Permission|\BackedEnum  $permission
     */
